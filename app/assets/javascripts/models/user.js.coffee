...
#  connected_user_ids: DS.attr()
  ...
  isConnectedWithLoggedUser: (->
    _loggedUserConnections = RailsDict.__container__.lookup("controller:connections").get('loggedUserConnections')
#    console.log "<<>>", parseInt(@get('id')), _loggedUserConnections
  ...
  isLoggedUserRequestedConnection: (->
    _loggedUserRequestedConnections = RailsDict.__container__.lookup("controller:connections").get('loggedUserRequestedConnections')
